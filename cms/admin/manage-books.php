...
<head>
    ...
    <title>Online Complaint Management System | Manage Complaints</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Manage Complaints</h4>
    </div>
     <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Type tha complaints</th>
                                            <th>Category</th>
                                            <th>Authority</th>
                                            <th>Unique</th>
                                            <th>How many days handle the complaints</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
