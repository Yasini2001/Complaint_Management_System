...
<head>
    ...
    <title>Online Complaints Management System | Sending Complaints</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Sending Complaints</h4>
...
<div class="form-group">
<label>Unique No<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Send It </button>
