...
<head>
    ...
    <title>Online Complaint Management System | Edit Complaints</title>
...
<div class="form-group">
<label>Unique Number<span style="color:red;">*</span></label>
...
<p class="help-block">It Must be unique</p>
 ...
 <div class="form-group">
 <label>How many days handle the Complaints<span style="color:red;">*</span></label>
