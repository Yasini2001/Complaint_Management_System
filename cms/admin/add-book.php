...
<head>
    ...
    <title>Online Complaints Management System | Add Complaints</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add Complaints</h4>
...
<label>Type the Complaints<span style="color:red;">*</span></label>
...
<p class="help-block">Id Must be unique</p>
</div>

 <div class="form-group">
 <label>No of days Handle the Complaints<span style="color:red;">*</span></label>
